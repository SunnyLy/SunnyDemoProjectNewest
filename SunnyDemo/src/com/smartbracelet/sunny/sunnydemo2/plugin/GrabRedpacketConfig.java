 ...
 * @Author sunny
 * @Date 2016/7/5  13:27
 * @Annotation Config常量类
 */
public class GrabRedpacketConfig {


    /**抢红包服务连接与断开连接**/
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "com.smartbracelet.sunny.sunnydemo2.plugin.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "com.smartbracelet.sunny.sunnydemo2.plugin.ACCESSBILITY_CONNECT";

    /**通知栏服务连接与断开连接**/
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT = "com.smartbracelet.sunny.sunnydemo2.plugin.NOTIFY_LISTENER_DISCONNECT";
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_CONNECT = "com.smartbracelet.sunny.sunnydemo2.plugin.NOTIFY_LISTENER_CONNECT";
    ...
    private static GrabRedpacketConfig current;

    public static synchronized GrabRedpacketConfig getConfig(Context context) {
        if(current == null) {
            current = new GrabRedpacketConfig(context.getApplicationContext());
        }
        return current;
    }
    ...
    private GrabRedpacketConfig(Context context) {
        mContext = context;
