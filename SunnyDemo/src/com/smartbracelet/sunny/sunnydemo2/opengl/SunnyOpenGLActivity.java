...
import com.smartbracelet.sunny.sunnydemo2.opengl.cubtriangle.SunnyCubTriangleGLSurfaceView;
...
public class SunnyOpenGLActivity extends FragmentActivity {
    ...
    private SunnyCubTriangleGLSurfaceView mGLSurfaceView;
    ...
    private void initView() {
      /*//  mGLSurfaceView = (SunnyGLSurfaceView) findViewById(R.id.demo_gl_surfaceview);
       ...
       // mGLRender = new GLES20TriangleRenderer(this);
        SunnyCubTriangleRender mRender = new SunnyCubTriangleRender(this);
        ...
        mGLSurfaceView = new SunnyCubTriangleGLSurfaceView(this);
        setContentView(mGLSurfaceView);
    }
