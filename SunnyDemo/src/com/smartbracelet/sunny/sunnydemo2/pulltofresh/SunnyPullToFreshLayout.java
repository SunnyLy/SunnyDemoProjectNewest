package com.smartbracelet.sunny.sunnydemo2.pulltofresh;
...
public class SunnyPullToFreshLayout extends LinearLayout implements View.OnTouchListener {
    ...
    public SunnyPullToFreshLayout(Context context) {
        super(context);
    }

    public SunnyPullToFreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        header = LayoutInflater.from(context).inflate(R.layout.widget_pull_to_fresh,
                null, true);
    ...
    private void setIsAbleToPull(MotionEvent event) {
        ...
        if (firstChild != null) {
            int firstVisiblePos = scrollView.getScrollY();// 是否滑动到顶部
