...
public class NumberPicker extends LinearLayout {
    ...
    //自定义NumberPicker显示的item项
    private int showItemCount = SELECTOR_WHEEL_ITEM_COUNT;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        //获取item显示的数量
        showItemCount = attributesArray.getInteger(R.styleable.NumberPicker_item_count_show,SELECTOR_WHEEL_ITEM_COUNT);
        SELECTOR_MIDDLE_ITEM_INDEX = showItemCount/2;
        mSelectorIndices = new int[showItemCount];
...
//        paint.setColor(color);
        ColorStateList colorStateList = mInputText.getTextColors();
        int color = colorStateList.getColorForState(ENABLED_STATE_SET, Color.WHITE);
        paint.setColor(color);
...
//                mInputText.setVisibility(View.INVISIBLE);
     ...
     * <p>
     * If the argument is less than the {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getMinValue()} and
     * {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getMinValue()} and
     * {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getMaxValue()} and
     * {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getMaxValue()} value.
     * </p>
     * <p>
...
//                mInputText.setVisibility(View.INVISIBLE);
     ...
     * wrap around the {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getMinValue()} and
     * {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker#getMaxValue()} values.
     * <p>
...
//            mInputText.setVisibility(View.INVISIBLE);
    ...
    private boolean updateInputTextView() {
        ...
        if (!TextUtils.isEmpty(text) && !text.equals(mInputText.getText().toString())) {
            ...
            mInputText.setTextColor(getResources().getColor(R.color.blue));
            mInputText.setTextSize(25);
            return true;
        }
    ...
    /**
     * Posts an {@link com.smartbracelet.sunny.sunnydemo2.widget.NumberPicker.SetSelectionCommand} from the given <code>selectionStart
